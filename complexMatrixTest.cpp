...
void testcase4() {
  ...
  auto matrixSrc1 = initial(3, 2, a);
  auto matrixRes1 = initial(3, 2, c);
  assertEquales(4, Matrix<complex<double>>::scalarDivision(2, matrixRes1),
                matrixSrc1);
}
...
void testcase5() {
  ...
  assertEquales(5, Matrix<complex<double>>::transposition(matrixSrc1),
                matrixRes1);
}
...
void tesecase6() {
  ...
  auto matrixRes1 = initial(3, 2, c);
  assertEquales(
      6, Matrix<complex<double>>::elementMultiplication(matrixSrc1, matrixSrc2),
      matrixRes1);
}
...
void testcase7() {
  ...
  assertEquales(
      7, Matrix<complex<double>>::matrixMultiplication(matrixSrc1, matrixSrc2),
      matrixRes1);
}
...
void testcase8() {
  ...
  assertEquales(
      8, Matrix<complex<double>>::vectorMultiplication(matrixSrc1, matrixSrc2),
      matrixRes1);
}
...
void testcase11() {
  ...
  auto matrixRes1 = initial(2, 2, d);
  assertEquales(11,
                Matrix<complex<double>>::crossProduct(matrixSrc1, matrixSrc2),
                matrixRes1);
}
...
void testcase24() {
  ...
  complex<double> a[] = {100 + 2i, 2342, 32, 40, 542, 62, 7,
                         8,        9,    10, 11, 12,  13};
  complex<double> b[] = {1, 2, 3, 4, 5, 6};
  complex<double> c[] = {1, 4, 2, 5, 3, 6};
  complex<double> d[] = {22, 28, 49, 64};
...
void testcase25() {
  ...
  complex<double> a[] = {100 + 2i, 100, 100, 99, 542, 62, 7,
                         8,        9,   10,  11, 12,  13};
  complex<double> b[] = {1, 2, 3, 4, 5, 6};
  complex<double> c[] = {1, 4, 2, 5, 3, 6};
  complex<double> d[] = {-0.201203 - 0.398382i, 0.203236 + 0.402406i,
                         0.203236 + 0.402406i, -0.195187 - 0.406471i};
  auto matrixSrc1 = initial(2, 2, a);
  auto matrixSrc2 = initial(2, 3, b);
  auto matrixRes1 = initial(2, 2, d);
...
void testcase27() {
  ...
  complex<double> a[] = {100 + 10i, 100, 100, 99, 542, 62, 7,
                         8,         9,   10,  11, 12,  13};
  complex<double> b[] = {1, 2, 3, 4, 5, 6};
  complex<double> c[] = {1, 4, 2, 5, 3, 6};
  complex<double> d[] = {0, 1, 1, -1};
...
void testcase28() {
  ...
  complex<double> a[] = {100, 100, 100, 99, 542 + 3i, 62, 7,
                         8,   9,   10,  11, 12,       13};
  complex<double> b[] = {1, 2, 3, 4, 5, 6};
  complex<double> c[] = {1, 4, 2, 5, 3, 6};
...
void testcase29() {
  ...
  complex<double> e[] = {2046 + 149i,  3257 + 44i,    1704 + 16i,  1132,
                         15286 + 580i, 39348 + 1192i, 36192 + 24i, 34627,
                         61511 + 28i,  134079 + 30i,  15631 + 32i, 2737,
                         1239,         3555,          3927,        4088};
  auto matrixSrc1 = initial(4, 4, a);
  auto matrixSrc2 = initial(3, 3, b);
  auto matrixRes1 = initial(4, 4, e);
  assertEquales(29,
                Matrix<complex<double>>::convolution(matrixSrc1, matrixSrc2),
                matrixRes1);
}
